"builtin.module"() ({
  ...
  ^0(%arg0 : !stencil.field<[-1 : i64, -1 : i64, -1 : i64], f64>, %arg1 : !stencil.field<[-1 : i64, -1 : i64, -1 : i64], f64>):
    ...
    %3, %4 = "stencil.apply"(%2) ({
    ^1(%5 : !stencil.temp<[66 : i64, 66 : i64, 63 : i64], f64>):
      %6 = "stencil.access"(%5) {"offset" = #stencil.index<[0 : i64, 0 : i64, 0 : i64]>} : (!stencil.temp<[66 : i64, 66 : i64, 63 : i64], f64>) -> f64
      %7 = "stencil.access"(%5) {"offset" = #stencil.index<[0 : i64, 2 : i64, 3 : i64]>} : (!stencil.temp<[66 : i64, 66 : i64, 63 : i64], f64>) -> f64
      %8 = "stencil.access"(%5) {"offset" = #stencil.index<[2 : i64, 2 : i64, 3 : i64]>} : (!stencil.temp<[66 : i64, 66 : i64, 63 : i64], f64>) -> f64
      %9 = "arith.addf"(%7, %8) {"fastmath" = #arith.fastmath<none>} : (f64, f64) -> f64
      %10 = "stencil.store_result"(%8) : (f64) -> !stencil.result<f64>
      %11 = "arith.subf"(%6, %9) {"fastmath" = #arith.fastmath<none>} : (f64, f64) -> f64
      %12 = "stencil.store_result"(%11) : (f64) -> !stencil.result<f64>
      "stencil.return"(%10, %12) : (!stencil.result<f64>, !stencil.result<f64>) -> ()
    ...
    %13, %check = "stencil.apply"(%5) ({
      %14 = "stencil.access"(%5) {"offset" = #stencil.index<[-1 : i64, 0 : i64, 0 : i64]>} : (!stencil.temp<[66 : i64, 66 : i64, 63 : i64], f64>) -> f64
      %15 = "stencil.access"(%5) {"offset" = #stencil.index<[1 : i64, 0 : i64, 0 : i64]>} : (!stencil.temp<[66 : i64, 66 : i64, 63 : i64], f64>) -> f64
      %16 = "arith.addf"(%7, %8) {"fastmath" = #arith.fastmath<none>} : (f64, f64) -> f64
      %17 = "stencil.store_result"(%8) : (f64) -> !stencil.result<f64>
