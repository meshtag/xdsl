"builtin.module"() ({
  ...
  ^0(%arg0 : !stencil.field<[-1 : i64, -1 : i64, -1 : i64], f64>, %arg1 : !stencil.field<[-1 : i64, -1 : i64, -1 : i64], f64>):
    ...
    ^1(%5 : !stencil.temp<[66 : i64, 66 : i64, 63 : i64], f64>):
      ...
      %10 = "arith.subf"(%6, %9) {"fastmath" = #arith.fastmath<none>} : (f64, f64) -> f64
      %11 = "stencil.store_result"(%10) : (f64) -> !stencil.result<f64>
      %12 = "stencil.store_result"(%9) : (f64) -> !stencil.result<f64>
      "stencil.return"(%11, %12) : (!stencil.result<f64>, !stencil.result<f64>) -> ()
