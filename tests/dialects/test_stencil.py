...
from xdsl.dialects.builtin import FloatAttr, f32, ArrayAttr, IntegerAttr, IntegerType
...
def test_index_attr_size_from_bounds():
    stencil_index_attr1 = IndexAttr.get(*[1, 2, 3])
    stencil_index_attr2 = IndexAttr.get(*[5, 6, 7])
    size_from_bounds = IndexAttr.size_from_bounds(
        stencil_index_attr1, stencil_index_attr2
    )

    assert size_from_bounds == [4, 4, 4]
