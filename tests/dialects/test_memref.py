...
def test_memref_subview():
    ...
    operand_segment_sizes = ArrayAttr.from_list([IntAttr.from_int(1), IntAttr.from_int(2),
                                                IntAttr.from_int(2), IntAttr.from_int(2)])
    ...
    subview = Subview.build(operands=[memref_ssa_value, [offset_arg1, offset_arg2], 
                            [size_arg1, size_arg2], 
