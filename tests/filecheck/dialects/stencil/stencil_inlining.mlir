// xdsl-opt ./tests/filecheck/dialects/stencil/stencil_inlining.mlir -t mlir -p stencil-inlining > stencil_inlining_lowered.mlir
...
"builtin.module"() ({
  ...
  ^0(%0 : !stencil.field<[-1 : i64, -1 : i64, -1 : i64], f64>, %1 : !stencil.field<[-1 : i64, -1 : i64, -1 : i64], f64>):
    ...
    ^1(%21 : !stencil.temp<[-1 : i64, -1 : i64, -1 : i64], f64>):
      ...
      %30 = "arith.mulf"(%26, %cst1) : (f64, f64) -> f64
      %31 = "arith.addf"(%30, %29) : (f64, f64) -> f64
