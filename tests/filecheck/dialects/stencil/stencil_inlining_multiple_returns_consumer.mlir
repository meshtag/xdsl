...
// CHECK-NEXT:       %10 = "arith.subf"(%6, %9) {"fastmath" = #arith.fastmath<none>} : (f64, f64) -> f64
// CHECK-NEXT:       %11 = "stencil.store_result"(%10) : (f64) -> !stencil.result<f64>
// CHECK-NEXT:       %12 = "stencil.store_result"(%9) : (f64) -> !stencil.result<f64>
// CHECK-NEXT:       "stencil.return"(%11, %12) : (!stencil.result<f64>, !stencil.result<f64>) -> ()
